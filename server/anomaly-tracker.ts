  ...
  return {
    ...
    pipelineHealth: {
      ...
      checks: [
        ...
        {
          id: "postdoc-545500",
          ok: POSTDOC_IMPROVEMENT_COUNT === 545500,
        ...
        },
        {
          ...
          ok: entities.length >= 15 && anomalies.length >= 51 && POSTDOC_IMPROVEMENT_COUNT === 545500,
          detail: "tracker-3d-smoke floors: nodes≥15 events≥51 postdoc=545500 top500-sota live-p1 bo-auto-queue chamber-crisp virtual",
        },
        {

...
export const metadata = {
  ...
  description:
    "Unclassified 3D business anomaly tracker with 24/7 Live P1 fixture telemetry, Black-owned auto-queue discovery, 3D anomaly chamber CRISP labels, and 725,500 post-doctoral forensic queries (TOP 500 SOTA, tracker-tab). Fixture data only — no intercepts or live NCIC.",
};
